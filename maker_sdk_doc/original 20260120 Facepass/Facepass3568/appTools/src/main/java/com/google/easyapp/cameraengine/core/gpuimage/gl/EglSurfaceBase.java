...
package com.google.easyapp.cameraengine.core.gpuimage.gl;
...
import com.google.easyapp.cameraengine.core.gpuimage.OpenGlUtils;
...
public class EglSurfaceBase {
    ...
    public boolean swapBuffers() {
        ...
        if (!result) {
            L.e(TAG, "WARNING: swapBuffers() failed");
        }
        return result;
    }
